...
namespace Reminder
{
    public partial class ReminderMain : Form
    {
        ...
        {
            if (txtBoxDescription.Text == reminders[listBoxReminders.SelectedIndex].Description && txtBoxSummary.Text == reminders[listBoxReminders.SelectedIndex].Summary && comboBoxReminderType.Text == reminders[listBoxReminders.SelectedIndex].ReminderType && dateTimePickerReminder.Value.ToString() == reminders[listBoxReminders.SelectedIndex].Summary)
            {
